package sopt.org.SixthSeminar.external.aws;
...
public class S3Service {
    ...
    public String uploadImage(MultipartFile multipartFile, String folder) {
        ...
        try(InputStream inputStream = multipartFile.getInputStream()) {
            ...
            throw new BadRequestException(Error.FAIL_SAVE_IMAGE_EXCEPTION, Error.FAIL_SAVE_IMAGE_EXCEPTION.getMessage());
        }
    }

    //postman에서 넣어줄 때는 multipartFileList[0],, 이렇게 ... 바로 넣어주면 됨 ! 근데 setter를 써줘야함
